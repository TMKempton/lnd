...
if __name__ == "__main__":
    ...
    for initial_context in initial_contexts:
        ...
        with open(artefact_dir / f"ln_top_p={top_p}_completion.json", "w") as f:
            f.write(
                json.dumps(
        ...
        for completion in completions:
            ...
            q_dist = compute_top_p_q_distribution(
    ...
    with open(result_dir / f"ln_top_p={top_p}_metrics.json", "w") as f:
